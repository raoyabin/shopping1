<%@ page language="java" import="com.shopping.user.*" pageEncoding="GBK"%>
...
<html><head><title>user modify</title>
...
<tbody><tr><td class="nav" align="left" nowrap="nowrap" width="90%">shopping mall</td>
...
<tbody><tr>
<td colspan="2" class="header">User Modify</td>
</tr>
<tr>
...
<tr>
<td class="altbg1" valign="top">deliver address:</td>
<td class="altbg2"><textarea name="addr" cols="60" rows="5" id="addr"><%=u.getAddr()%></textarea></td>
</tr>
<tr>
<td class="altbg1" valign="top">zipcode:</td>
<td class="altbg2"><input name="zipcode" type="text" id="zipcode" size="25" value="<%=u.getZipcode()%>"></td></tr>
</tbody></table>
<br>
...
<tbody><tr class="altbg1">
<td align="right"><a href="http://bbs.allsmart.com/member.php?action=clearcookies" class="bold">delete Cookies</a></td>
...
<a target="_blank" href="http://www.thinkpadclub.com.cn/"><u>shopping mall</u></a><br>
