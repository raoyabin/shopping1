...
<%@ page import="com.shopping.client.*, com.shopping.product.*" %>
...
<table align="center" border="1">
	...
	for(Iterator<CartItem> it = items.iterator(); it.hasNext(); ) {
		...
		<tr>
			...
			<td>
				...
				<a href="Buy.jsp?action=delete&id=<%=ci.getProduct().getId() %>">delete</a>
	...
	<tr>
		<td colspan=6>
			...
			<a href="javascript:document.forms[0].submit()">modify</a>
