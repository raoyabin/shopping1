...
<jsp:useBean id="searchBean" class="com.shopping.product.ProductSearchFormBean">
...
--></style>
	...
	<body leftmargin="0" rightmargin="0" topmargin="0"
		...
		<center><a href="ProductAdd.jsp" target="detail">add new product</a></center>
			...
			<tbody>
				...
				<tr>
					...
					<td class="altbg1" align="right">
						...
						<a target="detail" href="ProductModify.jsp?id=<%=p.getId()%>">modify</a>
					</td>
				</tr>
