...
--></style>
	...
	<body leftmargin="0" rightmargin="0" topmargin="0"
		...
		<center><a href="CategoryAdd.jsp">Add Category</a></center>
				...
				%>
					...
					<tr>
						...
						<td class="altbg2" align="right">
							<a  		href="CategoryModify.jsp?id=<%=c.getId()%>">change category</a> 
							<% if(c.getGrade()<Category.MAX_GRADE) { %>
								<a href="CategoryAddChild.jsp?pid=<%=c.getId()%>&grade=<%=c.getGrade()%>">  add category</a>
							<% } %>
						</td>
					</tr>
