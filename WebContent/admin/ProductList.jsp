...
--></style>
	...
	<body leftmargin="0" rightmargin="0" topmargin="0"
		...
		<center><a target="detail" href="ProductAdd.jsp" >add new product</a></center>
			...
			<tbody>
				...
				<tr>
					...
					<td class="altbg1" align="right">
						<a target="detail" href="ProductDelete.jsp?id=<%=p.getId()%>" onclick="return confirm('Delete?')">delete</a>
						<a  href="ProductModify.jsp?id=<%=p.getId()%>">modify</a>
						<a  href="ProductUpload.jsp?id=<%=p.getId()%>">upload</a>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="8" class="altbg2">
						...
						&nbsp; &nbsp;
						<span class="bold">or</span> &nbsp; sort type:
						<a
							href="http://bbs.allsmart.com/member.php?action=list&amp;order=credits">credits</a>
						-
						<a
							href="http://bbs.allsmart.com/member.php?action=list&amp;order=username">username</a>
						-
						<a
							href="http://bbs.allsmart.com/member.php?action=list&amp;order=gender">gender</a>
						-
						<a
							href="http://bbs.allsmart.com/member.php?action=list&amp;order=regdate">register date</a>
						-
						<a
							href="http://bbs.allsmart.com/member.php?action=list&amp;admins=yes">admin level</a>
					</td>
				</tr>
			</tbody>
		</table>
