...
<%@ page import="com.shopping.user.*,java.sql.*"%>
...
<html>
	<head>
		...
		<meta name="description" content="425 member list">
			...
			<tbody>
				...
				<tr>
					...
					<td class="altbg1" align="right">
						...
						<a target="detail" href="UserDelete.jsp?id=<%=u.getId()%>&from=<%=url%>" onclick="return confirm('are you sure for delete?')">delete</a>
					</td>
				</tr>
				...
				<tr>
					<td colspan="5" class="altbg2">
						...
						-
						<a
							href="http://bbs.allsmart.com/member.php?action=list&amp;admins=yes">manage level</a>
					</td>
				</tr>
			</tbody>
		</table>
