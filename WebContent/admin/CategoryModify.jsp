<%@ page language="java" import="com.shopping.category.*" pageEncoding="GBK"%>
...
<html><head><title>shopping mall modify category</title>
...
<tbody><tr><td class="nav" align="left" nowrap="nowrap" width="90%">Shopping mall category modify</td>
<td align="right" width="10%">&nbsp;<a href="#bottom"><img src="images/arrow_dw.gif" align="absmiddle" border="0"></a></td>        
</tr></tbody></table><br>
<form method="get" name="register" action="CategoryModify.jsp" onSubmit="this.regsubmit.disabled=true;">
<input type="hidden" name="action" value="modify"/>
<input type="hidden" name="id" value="<%=id%>"/>
<table class="tableborder" align="center" cellpadding="4" cellspacing="1" width="97%">
<tbody><tr>
<td colspan="2" class="header">Add category</td>
</tr>
<tr>
<td class="altbg1" width="21%">Category name:</td>
<td class="altbg2"><input name="name" size="25" maxlength="25" type="text" value="<%=c.getName()%>"> 
</tr>

<tr>
<td class="altbg1" valign="top">category description:</td>
