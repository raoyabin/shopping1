...
<html><head><title>product modify</title>
...
<br>
<form method="get" name="formModify" action="ProductModify.jsp" onsubmit="return check()">
<input type="hidden" name="action" value="add"/>
<input type="hidden" name="id" value="<%=id %>"/>

<table class="tableborder" align="center" cellpadding="4" cellspacing="1" width="97%">
<tbody><tr>
<td colspan="2" class="header">product modify</td>
</tr>
<tr>
...
<td class="altbg1">memeber price:</td>
...
<tr>
<td class="altbg1" valign="top">description:</td>
